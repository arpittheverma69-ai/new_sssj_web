                        ...
                        return (
                            <div key={step.id} className="relative z-10 flex flex-col items-center">
                                ...
                                <div className="mt-3 text-center">
                                    <div className={`font-semibold text-sm transition-colors duration-300 ${isActive || isCompleted ? 'text-foreground' : 'text-muted-foreground'
                                        }`}>
                                        {step.label}
                                    </div>
                                    <div className={`text-xs mt-1 transition-colors duration-300 ${isActive || isCompleted ? 'text-foreground/70' : 'text-muted-foreground'
                                        }`}>
                                        {step.description}
                                    </div>
                                </div>
                                ...
                                {/* Step Number */}
                                <div className={`absolute -top-2 -right-2 w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center transition-all duration-300 ${isCompleted
